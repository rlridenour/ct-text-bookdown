...
thinking as well. Critical thinkers must become certain kinds of people,
that is we need to acquire certain intellectual virtues. So, we will
...
[^1]: That doesn't mean that the test should be ignored. It just means
